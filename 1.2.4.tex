...
Here
\begin{align}
\label{eq:tri-pts/1}a&=105\\
\label{eq:tri-pts/2}d&=5
\end{align}
\begin{align}
\label{eq:tri-pts/3}a_n&=a+(n-1)d
\end{align}
From \eqref{eq:tri-pts/3}
\begin{align}
105+(n-1)5&=995\\
(n-1)5&=995-105=890\\
n-1&=178\\
...
\end{align}
\begin{align}
\label{eq:tri-pts/8}S_n&=\frac{n}{2}[2a+(n-1)d]
\end{align}
From \eqref{eq:tri-pts/8}
\begin{align}
\therefore S_n&=\frac{179}{2}[2(105)+(179-1)(5)]\\
